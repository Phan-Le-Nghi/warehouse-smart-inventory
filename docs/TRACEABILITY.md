...
| `REQ-002/003/004`, `CAND-REQ-003/007/010` | `US-PUT-001` | [#8](https://tree.taiga.io/project/lenghi-group-07-project/us/8) / ID `9523823` — Ready (documented as ready to mark Done; remote status unchanged) | `T-PUT-01` [#19](https://tree.taiga.io/project/lenghi-group-07-project/task/19); `T-PUT-02` [#20](https://tree.taiga.io/project/lenghi-group-07-project/task/20); `T-PUT-03` [#21](https://tree.taiga.io/project/lenghi-group-07-project/task/21) — remote status New; documented work completed | `PF-01 — Receive → Putaway`; `SCR-03`; [`06-technical/story-specs/putaway.md`](06-technical/story-specs/putaway.md) | COMPLETED; API/DB/migration/UI merged; PostgreSQL 18 backend, frontend and Playwright E2E checks PASS in GitHub Actions |
