...
| Figma access/frame parity chưa được human verify | Chưa thể xác nhận exact prototype frames khớp screen inventory và approved flows | Giữ URL và screen inventory; yêu cầu human access/parity review | UX/UI — Nghĩa |
