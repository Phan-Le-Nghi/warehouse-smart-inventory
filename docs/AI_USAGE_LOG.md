...
- **Human verification:** Pending — con người cần review toàn bộ diff, xác nhận UI parity với Figma `PF-01`/`SCR-03`, và xem kết quả PostgreSQL/Playwright từ CI hoặc môi trường Docker thật trước integration.
- **Human decision:** Stack, technical contracts và fixture 16 units là input đã duyệt. Full placement chỉ là test scope; `OQ-012`, `OQ-013`, `OQ-014`, production authentication và deployment vẫn OPEN/TBD.
