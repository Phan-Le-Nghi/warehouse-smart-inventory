...
|---|---|---|---|---|---|---|---|
| `US-TRF-001` | Nguyễn Thị Ly Na | `CAND-REQ-003/004/011`, `CAND-BR-003/007/008/015`, `DEC-007/010/013/017/019` | Canonical execution/confirmation and negative-stock guard flow | Chưa tạo | Architecture/API/data model remain TBD | Chưa thực thi | HUMAN PRODUCT DECISIONS / MVP ASSUMPTIONS; `EVD-010`, `EVD-011`, `EVD-019` are context only |
