...
| QA-009 | Rule      | AI có được tự xác định Warehouse Staff được phép Adjust Stock không?                                                     | Không. Permission của các role chưa được xác nhận và đang thuộc `OQ-020`.                                                                                                 | `OQ-020`, `vault/03-domain/roles.md`                       |
...
| QA-015 | Unknown   | Transfer có tự động cập nhật Stock không?                                                                                | KHÔNG CÓ DỮ LIỆU. Chưa có quyết định xác nhận Transfer có tự động cập nhật Stock.                                                                                         | `EVD-011`, `OQ-013`, `OQ-014`                              |
| QA-016 | Unknown   | Transfer có tự động thay đổi Location của SKU không?                                                                     | KHÔNG CÓ DỮ LIỆU. Location behavior và cách quản lý nhiều location vẫn chưa được xác nhận đầy đủ.                                                                         | `EVD-008`, `OQ-016`                                        |
| QA-017 | Unknown   | Transfer có bắt buộc thực hiện giữa hai Warehouse khác nhau không?                                                       | KHÔNG CÓ DỮ LIỆU. Phạm vi Transfer giữa location, warehouse hoặc cả hai vẫn là `OQ-016`.                                                                                  | `OQ-016`                                                   |
...
* Khẳng định Transfer chắc chắn cập nhật Stock.
* Khẳng định Transfer chắc chắn đổi Location.
* Tự xác định quyền của Warehouse Staff / Manager / Purchasing / Admin.
