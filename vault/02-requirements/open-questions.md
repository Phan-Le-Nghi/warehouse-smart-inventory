...
| OQ-010 | Phạm vi hệ thống gồm một Warehouse hay nhiều Warehouse? | Domain và quy trình |
| OQ-011 | Stock on-hand, available, reserved, damaged và in-transit được định nghĩa như thế nào, nếu có áp dụng? | Yêu cầu Stock |
...
| OQ-016 | Transfer là giữa các location, giữa các Warehouse hay cả hai? | Phạm vi Transfer |
