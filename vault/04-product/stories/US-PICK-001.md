...
- Requirements: `REQ-002`, `REQ-003`, `CAND-REQ-003`, `CAND-REQ-006`, `CAND-REQ-010`.
- Business rules: `CAND-BR-003`, `CAND-BR-005`, `CAND-BR-006`.
- Human decisions: `DEC-010`, `DEC-012`, `DEC-017`.
- Open questions: `OQ-013`, `OQ-015`, `OQ-022`.
...
- Negative-stock behavior vẫn `OQ-015`; device/integration behavior vẫn `OQ-022`.
