...
- Requirements: `REQ-001`, `REQ-002`, `REQ-004`, `CAND-REQ-003`, `CAND-REQ-004`, `CAND-REQ-010`.
- Business rules: `CAND-BR-003`, `CAND-BR-007`, `CAND-BR-008`.
- Human decisions: `DEC-005`, `DEC-007`, `DEC-009`, `DEC-010`, `DEC-013`, `DEC-017`.
- Open questions: `OQ-013`, `OQ-014`, `OQ-015`, `OQ-022`.
...
- Partial Transfer vẫn `OQ-014`; negative-stock behavior vẫn `OQ-015`; device/integration behavior vẫn `OQ-022`.
